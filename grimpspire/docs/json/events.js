/**
 * Données des événements aléatoires du jeu
 */
window.EVENTS_DATA = [
    {
        "id": "citizen_donation",
    ...
    },
    {
        ...
        "messages": [
            "Un marchand reconnaissant vous offre quelques matériaux.",
            "Un citoyen satisfait fait un petit don à la ville.",
            "Un artisan de passage laisse une donation."
        ]
    },
    {
